    ...
    <header>
        <nav class="navbar navbar-expand-lg bg-body-tertiary">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="index.jsp#productos">Inicio</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="index.jsp#soluciones">Categorias</a>
                </li>
                <li class="nav-item">
    ...
    <div class="contenedor-form register">
        <div class="content">
            <div class="text-sci">
                ...
                <p>También puedes seguirnos en nuestras redes sociales para enterarte de las nuevas tendencias.</p>
            ...
            <div class="form-box">
                ...
                <input type="hidden" name="type" value="register">
                    ...
                    <div class="input-box">
                        ...
                        <input type="text" name="txtFirstName" autocomplete="off" required>
                        <label>Nombre</label>
                    </div>
                    <div class="input-box">
                        <span class="icon"><i class="bi bi-person"></i></span>
                        <input type="text" name="txtLastName" autocomplete="off" required>
                        <label>Apellidos</label>
                    </div>
                  
                    <div class="input-box">
                        <span class="icon"><i class="bi bi-telephone-fill"></i></span>
                        <input type="number" name="txtPhone" autocomplete="off" required>
